         ...
         className={styles.About_me_cover}>
            ...
            transition={{
             ...
             className={styles.my_picture}>
                ...
                style={{backgroundImage:`url(/portfolio-site/images/profile.jpeg)`,backgroundSize:"cover"}}
                >
