    ...
    return(
        ...
        <div id = "contact"className={styles.covers}>
                ...
                <div className={styles.copy_right}>
                   <a href="mailto:nivaas23barath123@gmail.com" target="_blank"> <motion.li
                    initial = {{opacity:0,x:-200}}
                    whileInView={{opacity:1,x:0}}
                    end={{opacity:0,x:-200}}
                    transition={{
                     ...
                     className={styles.mail}><img src="/portfolio-site/images/mail.png" />nivaas23barath123@gmail.com</motion.li></a>
                    <motion.p
                    initial = {{opacity:0,x:-200}}
                    whileInView={{opacity:1,x:0}}
                    end={{opacity:0,x:-200}}
                    transition={{
                     ...
                     className={styles.copy}>© {new Date().getFullYear()} | Nivaas B</motion.p>
                </div>
        </div>
